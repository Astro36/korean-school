  ...
  getSummary(school, callback) {
    request.post({
      ...
      if (err) {
        ...
        const data = {
          area: document.querySelector('.School_Division .mapD_Area._10').textContent,
          class: document.querySelector('.School_Division .mapD_Class._04').textContent,
        };
...
schoolinfo.getSummary(find('경기', '백마고'), data => console.log(data));
